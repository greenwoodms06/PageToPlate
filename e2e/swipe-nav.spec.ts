// Swipe tab navigation (round-1 amendment 3): a horizontal flick moves
// between the four main tabs; it must NOT fire from inside a horizontally
// scrollable element (e.g. Browse's filter-chip row — scrolling chips is not
// a tab switch). Touch is emulated through CDP Input.dispatchTouchEvent so
// the events hit-test to real targets, exercising useSwipeTabs' guard walk.
